...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image: url({{ asset('img/background.svg') }});">
            ...
            <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-100 mx-6 lg:mx-0">
                ...
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <div class="pt-12 pb-8 grid w-full lg:block">
                        ...
                        <a href="https://www.linkedin.com/in/jarumi-woods-382923107/" class="bg-green-700 hover:bg-green-900 mb-2 lg:mb-0 text-white font-bold py-2 px-4 rounded-full">
                            <button>
                                LinkedIn
                            </button>
                        </a>
